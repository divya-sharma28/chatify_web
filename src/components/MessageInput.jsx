...
const MessageInput = () => {
  ...
  const handleImageChange = (e) => {
    ...
    reader.onloadend = () => setImagePreview(reader.result); // Set preview once file is read
    reader.readAsDataURL(file); // Read the file as a data URL so it can be used as an image source in the preview
  };
